...
<div class="modal fade" id="addpost" tabindex="-1"  aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content" >
            <div class="modal-header">
                <h5 class="modal-title">Share New Post</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="assets/php/actions.php?addpost" enctype="multipart/form-data">
                    <div class="my-3">
                        <label for="exampleFormControlTextarea1" class="form-label">If you want to upload a Photo then select it </label>
...
<div class="modal fade" id="chatbox" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <textarea class="form-control round-left border-0" id="msginput" placeholder="Enter text..."
aria-label="Recipient's username" aria-describedby="button-addon2" style="max-height:150px;"></textarea>
                            <button class="btn btn-primary text-black border-left" id="sendmsg" data-user-id="0" type="button" style="max-height:45px;">Send ></button>
                        </div>
      </div>
    </div>
  </div>
