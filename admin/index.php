...
<head>
  ...
  <title>avoScape - Dashboard</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class=" btn btn-danger" href="php/admin_actions.php?logout" role="button">
          Logout
        </a>
      </li>
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">avoScape</span>
    </a>
...
?>
 <div class="card card-primary bg-grad col-12">
              <!-- /.card-header -->
              <!-- form start -->
